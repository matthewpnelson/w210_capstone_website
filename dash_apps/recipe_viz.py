...
def reference_load():
    ...
    grain_reference = pd.read_csv('reference/grain_reference2.csv')
    grain_reference['Aliases'].fillna('', inplace=True)
    # Hops
    hop_reference = pd.read_csv('reference/hop_reference.csv')
    hop_reference['Aliases'].fillna('', inplace=True)
    # Yeasts
    yeast_reference = pd.read_csv('reference/yeast_reference.csv')
